...
public class ProjectPackager {
     ...
     */
    private static void PackDirectory(String startingDirectory,
                                      File theDirectory,
        ...
        for (File theFile : theFiles) {
            String sRelPath = theFile.getPath().substring(j);
            if (theFile.isDirectory()) {
                ...
                // recurse down
                PackDirectory(startingDirectory, theFile, theZIPStream);
            } else // regular file
            {
                File f = theFile;
