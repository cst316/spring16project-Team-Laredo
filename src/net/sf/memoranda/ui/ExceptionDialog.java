...
public class ExceptionDialog extends JDialog {
    ...
    private void jbInit() {
        ...
        reportB.addActionListener(e -> reportB_actionPerformed());
        ...
        closeB.addActionListener(e -> closeB_actionPerformed());
        this.getRootPane().setDefaultButton(closeB);
        jPanel3.setLayout(flowLayout1);
        flowLayout1.setAlignment(FlowLayout.RIGHT);
        copyB.setText("Copy to clipboard");
        copyB.addActionListener(e -> copyB_actionPerformed());
    ...
    private void copyB_actionPerformed() {
    ...
    private void reportB_actionPerformed() {
