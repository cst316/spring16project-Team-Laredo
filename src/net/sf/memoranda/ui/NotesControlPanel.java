...
class NotesControlPanel extends JPanel {
    private final BorderLayout borderLayout1 = new BorderLayout();
    private final SearchPanel searchPanel = new SearchPanel();
    private final NotesListPanel notesListPanel = new NotesListPanel();
    private final BookmarksPanel bookmarksListPanel = new BookmarksPanel();
    private final JTabbedPane tabbedPane = new JTabbedPane();
    private final JToolBar toolBar = new JToolBar();
    private final FlowLayout flowLayout1 = new FlowLayout();
    private final JButton ppOpenB = new JButton();
    private final JPanel buttonsPanel = new JPanel();
    private final JMenuItem ppAddBkmrk = new JMenuItem();
    private final JMenuItem ppClearNote = new JMenuItem();
    //    JMenuItem ppInvertSort = new JMenuItem();
    private final JCheckBoxMenuItem ppInvertSort = new JCheckBoxMenuItem();
    private final JPopupMenu notesPPMenu = new JPopupMenu();
    private final JMenuItem ppOpenNote = new JMenuItem();
    private final JMenuItem ppRemoveBkmrk = new JMenuItem();
    ...
    private void jbInit() {
        ...
        tabbedPane.addChangeListener(e -> tabbedPane_stateChanged());
        ...
        ppAddBkmrk.addActionListener(e -> ppAddBkmrk_actionPerformed());
        ppAddBkmrk.setIcon(
        ...
        ppClearNote.addActionListener(e -> ppClearNote_actionPerformed());
        ppClearNote.setIcon(
        ...
        ppOpenNote.addActionListener(e -> ppOpenNote_actionPerformed());
        ...
        ppInvertSort.addActionListener(e -> ppInvertSort_actionPerformed());
        ...
        ppRemoveBkmrk.addActionListener(e -> ppRemoveBkmrk_actionPerformed());
        ...
        ListSelectionListener lsl = e -> ppSetEnabled();
    ...
    private void ppAddBkmrk_actionPerformed() {
    ...
    private void ppClearNote_actionPerformed() {
        String msg;
...
//		((AppFrame)App.getFrame()).workPanel.dailyItemsPanel.editorPanel.editor.requestFocus();
    ...
    private void ppOpenNote_actionPerformed() {
        setActiveNote();
    }
    ...
    private void ppRemoveBkmrk_actionPerformed() {
        for (int i = 0; i < notesList.getSelectedIndices().length; i++) {
            Note note = notesList.getNote(notesList.getSelectedIndices()[i]);
            note.setMark(false);
        }
