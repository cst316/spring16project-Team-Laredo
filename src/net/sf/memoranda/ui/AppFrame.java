...
public class AppFrame extends JFrame {
    ...
    private static final Vector exitListeners = new Vector();
    public final WorkPanel workPanel = new WorkPanel();
    private final Action prjPackAction = new AbstractAction("Pack current project") {
        public void actionPerformed(ActionEvent e) {
            doPrjPack();
        }
    };
    private final Action minimizeAction = new AbstractAction("Close the window") {
        public void actionPerformed(ActionEvent e) {
            doMinimize();
        }
    };
    ...
    private final Action exportNotesAction =
    ...
    private final Action importNotesAction =
            new AbstractAction(Local.getString("Import multiple notes")) {

                public void actionPerformed(ActionEvent e) {
                    ppImport_actionPerformed();
                }
            };
    private final Action importOneNoteAction =
    ...
    private final Action prjUnpackAction = new AbstractAction("Unpack project") {
        public void actionPerformed(ActionEvent e) {
            doPrjUnPack();
        }
    };
    private final JMenu jMenuEdit = new JMenu();
    private final JMenu jMenuFormat = new JMenu();
    private final JMenu jMenuInsert = new JMenu();
    private final HTMLEditor editor = workPanel.dailyItemsPanel.editorPanel.editor;
    private final JMenuItem jMenuFileNewPrj = new JMenuItem();
    private final JMenuItem jMenuFileNewNote = new JMenuItem(workPanel.dailyItemsPanel.editorPanel.newAction);
    private final JMenuItem jMenuFilePackPrj = new JMenuItem(prjPackAction);
    private final JMenuItem jMenuFileUnpackPrj = new JMenuItem(prjUnpackAction);
    private final JMenuItem jMenuFileExportPrj = new JMenuItem(exportNotesAction);
    private final JMenuItem jMenuFileImportPrj = new JMenuItem(importNotesAction);
    private final JMenuItem jMenuFileImportNote = new JMenuItem(importOneNoteAction);
    private final JMenuItem jMenuFileExportNote = new JMenuItem(
            workPanel.dailyItemsPanel.editorPanel.exportAction);
    private final JMenuItem jMenuFileMin = new JMenuItem(minimizeAction);
    private final JMenuItem jMenuEditUndo = new JMenuItem(editor.undoAction);
    private final JMenuItem jMenuEditRedo = new JMenuItem(editor.redoAction);
    private final JMenuItem jMenuEditCut = new JMenuItem(editor.cutAction);
    private final JMenuItem jMenuEditCopy = new JMenuItem(editor.copyAction);
    private final JMenuItem jMenuEditPaste = new JMenuItem(editor.pasteAction);
    private final JMenuItem jMenuEditPasteSpec = new JMenuItem(editor.stylePasteAction);
    private final JMenuItem jMenuEditSelectAll = new JMenuItem(editor.selectAllAction);
    private final JMenuItem jMenuEditFind = new JMenuItem(editor.findAction);
    private final JMenu jMenuGo = new JMenu();
    private final JMenuItem jMenuInsertImage = new JMenuItem(editor.imageAction);
    private final JMenuItem jMenuInsertTable = new JMenuItem(editor.tableAction);
    private final JMenuItem jMenuInsertLink = new JMenuItem(editor.linkAction);
    private final JMenu jMenuInsertList = new JMenu();
    private final JMenuItem jMenuInsertListUL = new JMenuItem(editor.ulAction);
    private final JMenuItem jMenuInsertListOL = new JMenuItem(editor.olAction);
    private final JMenuItem jMenuInsertBR = new JMenuItem(editor.breakAction);
    private final JMenuItem jMenuInsertHR = new JMenuItem(editor.insertHRAction);
    private final JMenuItem jMenuInsertChar = new JMenuItem(editor.insCharAction);
    private final JMenuItem jMenuInsertDate = new JMenuItem(
            workPanel.dailyItemsPanel.editorPanel.insertDateAction);
    private final JMenuItem jMenuInsertTime = new JMenuItem(
            workPanel.dailyItemsPanel.editorPanel.insertTimeAction);
    private final JMenuItem jMenuInsertFile = new JMenuItem(
            workPanel.dailyItemsPanel.editorPanel.importAction);
    private final JMenu jMenuFormatPStyle = new JMenu();
    private final JMenuItem jMenuFormatP = new JMenuItem(editor.new BlockAction(editor.T_P
    ));
    private final JMenuItem jMenuFormatH1 = new JMenuItem(editor.new BlockAction(editor.T_H1
    ));
    private final JMenuItem jMenuFormatH2 = new JMenuItem(editor.new BlockAction(editor.T_H2
    ));
    private final JMenuItem jMenuFormatH3 = new JMenuItem(editor.new BlockAction(editor.T_H3
    ));
    private final JMenuItem jMenuFormatH4 = new JMenuItem(editor.new BlockAction(editor.T_H4
    ));
    private final JMenuItem jMenuFormatH5 = new JMenuItem(editor.new BlockAction(editor.T_H5
    ));
    private final JMenuItem jMenuFormatH6 = new JMenuItem(editor.new BlockAction(editor.T_H6
    ));
    private final JMenuItem jMenuFormatPRE = new JMenuItem(editor.new BlockAction(
            editor.T_PRE));
    private final JMenuItem jMenuFormatBLCQ = new JMenuItem(editor.new BlockAction(
            editor.T_BLOCKQ));
    private final JMenu jjMenuFormatChStyle = new JMenu();
    private final JMenuItem jMenuFormatChNorm = new JMenuItem(editor.new InlineAction(
            editor.I_NORMAL));
    private final JMenuItem jMenuFormatChEM = new JMenuItem(editor.new InlineAction(
            editor.I_EM));
    private final JMenuItem jMenuFormatChSTRONG = new JMenuItem(editor.new InlineAction(
            editor.I_STRONG));
    private final JMenuItem jMenuFormatChCODE = new JMenuItem(editor.new InlineAction(
            editor.I_CODE));
    private final JMenuItem jMenuFormatChCite = new JMenuItem(editor.new InlineAction(
            editor.I_CITE));
    private final JMenuItem jMenuFormatChSUP = new JMenuItem(editor.new InlineAction(
            editor.I_SUPERSCRIPT));
    private final JMenuItem jMenuFormatChSUB = new JMenuItem(editor.new InlineAction(
            editor.I_SUBSCRIPT));
    private final JMenuItem jMenuFormatChCustom = new JMenuItem(editor.new InlineAction(
            editor.I_CUSTOM));
    private final JMenuItem jMenuFormatChB = new JMenuItem(editor.boldAction);
    private final JMenuItem jMenuFormatChI = new JMenuItem(editor.italicAction);
    private final JMenuItem jMenuFormatChU = new JMenuItem(editor.underAction);
    private final JMenu jMenuFormatAlign = new JMenu();
    private final JMenuItem jMenuFormatAlignL = new JMenuItem(editor.lAlignAction);
    private final JMenuItem jMenuFormatAlignC = new JMenuItem(editor.cAlignAction);
    private final JMenuItem jMenuFormatAlignR = new JMenuItem(editor.rAlignAction);
    private final JMenu jMenuFormatTable = new JMenu();
    private final JMenuItem jMenuFormatTableInsR = new JMenuItem(editor.insertTableRowAction);
    private final JMenuItem jMenuFormatTableInsC = new JMenuItem(editor.insertTableCellAction);
    private final JMenuItem jMenuFormatProperties = new JMenuItem(editor.propsAction);
    private final JMenuItem jMenuGoHBack = new JMenuItem(History.historyBackAction);
    private final JMenuItem jMenuGoFwd = new JMenuItem(History.historyForwardAction);
    private final JMenuItem jMenuGoDayBack = new JMenuItem(
            workPanel.dailyItemsPanel.calendar.dayBackAction);
    private final JMenuItem jMenuGoDayFwd = new JMenuItem(
            workPanel.dailyItemsPanel.calendar.dayForwardAction);
    private final JMenuItem jMenuGoToday = new JMenuItem(
            workPanel.dailyItemsPanel.calendar.todayAction);
    private final JMenuItem jMenuEditPref = new JMenuItem(preferencesAction);
    private final JMenu jMenuInsertSpecial = new JMenu();
    private final JMenu jMenuHelp = new JMenu();
    private final JMenuItem jMenuHelpGuide = new JMenuItem();
    private final JMenuItem jMenuHelpWeb = new JMenuItem();
    private final JMenuItem jMenuHelpBug = new JMenuItem();
    private final JMenuItem jMenuHelpAbout = new JMenuItem();
    private boolean prPanelExpanded = false;
    ...
    private static void exitNotify() {
        for (Object exitListener : exitListeners) ((ActionListener) exitListener).actionPerformed(null);
    }
    ...
    private void jbInit() throws Exception {
        ...
        jMenuHelpWeb.addActionListener(e -> jMenuHelpWeb_actionPerformed());

        jMenuHelpBug.setText(Local.getString("Report a bug"));
        jMenuHelpBug.addActionListener(e -> jMenuHelpBug_actionPerformed());

        jMenuHelpAbout.setText(Local.getString("About Memoranda"));
        jMenuHelpAbout.addActionListener(e -> jMenuHelpAbout_actionPerformed());
    ...
    private void jMenuHelpBug_actionPerformed() {
        Util.runBrowser(App.BUGS_TRACKER_URL);
    }

    private void jMenuHelpWeb_actionPerformed() {
...
//            super.processWindowEvent(e);
    ...
    private void ppExport_actionPerformed() {
        // Fix until Sun's JVM supports more locales...
        UIManager.put(
        ...
        ProjectExporter.export(CurrentProject.get(), chooser.getSelectedFile(), enc, xhtml,
                dlg.splitChB.isSelected(), nument, dlg.titlesAsHeadersChB.isSelected());
    }

    private void ppImport_actionPerformed() {
