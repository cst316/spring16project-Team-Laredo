...
public class EditorPanel extends JPanel {
    ...
    private final JButton importB = new JButton();
    private final JButton exportB = new JButton();
    private final JButton redoB = new JButton();
    ...
    private final JButton pasteB = new JButton();
    private final JButton historyForwardB = new JButton();
    private final JButton insDateB = new JButton();
    private final JButton insTimeB = new JButton();
    // JButton printB = new JButton();
    private final JButton undoB = new JButton();
    private final JButton cutB = new JButton();
    ...
    public final Action insertTimeAction = new AbstractAction(Local
        ...
        public void actionPerformed(ActionEvent e) {
            insTimeB_actionPerformed();
        }
    };
    public final Action insertDateAction = new AbstractAction(Local
            .getString("Insert current date"), new ImageIcon(
            net.sf.memoranda.ui.AppFrame.class
                    .getResource("resources/icons/date.png"))) {
        public void actionPerformed(ActionEvent e) {
            insDateB_actionPerformed();
        }
    };
    public final Action exportAction = new AbstractAction(Local
            .getString("Export note to file"), new ImageIcon(
            net.sf.memoranda.ui.AppFrame.class
                    .getResource("resources/icons/export.png"))) {
        public void actionPerformed(ActionEvent e) {
            exportB_actionPerformed();
        }
    };
    public final Action importAction = new AbstractAction(Local
            .getString("Insert file"), new ImageIcon(
            net.sf.memoranda.ui.AppFrame.class
                    .getResource("resources/icons/import.png"))) {
        public void actionPerformed(ActionEvent e) {
            importB_actionPerformed();
        }
    };
    private final Action previewAction = new AbstractAction(Local
            .getString("Preview note in browser"), new ImageIcon(
            net.sf.memoranda.ui.AppFrame.class
                    .getResource("resources/icons/preview.png"))) {
        public void actionPerformed(ActionEvent e) {
            previewB_actionPerformed();
        }
    };
    private String initialTitle = "";
    public final Action newAction = new AbstractAction(Local.getString("New note"),
            new ImageIcon(net.sf.memoranda.ui.AppFrame.class
                    .getResource("resources/icons/filenew.png"))) {
        public void actionPerformed(ActionEvent e) {
            newB_actionPerformed();
        }
    };

    public EditorPanel(DailyItemsPanel parent) {
        try {
            DailyItemsPanel parentPanel = parent;
            jbInit();
        } catch (Exception ex) {
    ...
    private void importB_actionPerformed() {
        // Fix until Sun's JVM supports more locales...
        UIManager.put("FileChooser.lookInLabelText", Local
                .getString("Look in:"));
        UIManager.put("FileChooser.upFolderToolTipText", Local
    ...
    private void newB_actionPerformed() {
